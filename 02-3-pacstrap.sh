...
pacstrap /mnt base base-devel "${kernel}" linux-firmware "${microcode}" efibootmgr grub grub-btrfs inotify-tools snapper snap-pac git sudo nano firewalld rsync openssh zsh zsh-completions lsd fzf zoxide unzip zip usbutils
